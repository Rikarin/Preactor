namespace Preactor.CustomStyleSheets {
    public class StyleSheetImportGlossary {
        ...
        public readonly string invalidHighResAssetType = Tr(
        ...
        public readonly string selectorStartsWithDigitFormat =
            Tr("Unsupported selector format. Selector names can not start with a digit. '{0}'");
        public readonly string unknownFunction = Tr("Unknown function '{0}' in declaration '{1}: {0}'");
        public readonly string circularImport = Tr(
        ...
        public readonly string invalidAssetType = Tr(
            "Unsupported type {0} for asset at path '{1}' ; only the following types are supported: {2}\nSuggestion: verify the import settings of this asset."
        );
        public readonly string unknownPseudoClass = Tr("Unknown pseudo-class '{0}' in selector '{1}`");
